...
# Maps: display_name -> map code (for changelevel / host_workshop_map)
MAPS = {
...
# Game modes: name -> RCON command
GAME_MODES = {
    "Casual": "exec casual.cfg",
    "Competitive": "exec valve-competitive.cfg",
    "Wingman": "exec wingman.cfg",
    "Deathmatch": "exec deathmatch.cfg",
...
# Mode -> list of map names available for that mode
MODE_MAPS = {
    "Competitive": [
        "de_ancient", "de_anubis", "de_inferno", "de_mirage", "de_nuke",
        "de_dust2", "de_train", "de_vertigo", "cs_italy", "cs_office",
        "de_overpass", "de_jura", "de_grail", "cs_agency", "de_basalt",
        "de_edin", "de_assembly", "de_cbble", "de_cache",
    ],
    "Retakes": [
        "de_ancient", "de_anubis", "de_inferno", "de_mirage", "de_nuke",
    ...
    "Wingman": [
        "de_dust2_wingman", "de_mirage_d", "cs_italy", "cs_office",
        "de_vertigo", "de_ancient", "de_anubis", "de_inferno", "de_nuke",
        "de_train", "de_overpass", "ar_shoots", "de_brewery", "de_dogtown",
        "gd_rialto",
    ],
    "Deathmatch": [
        "de_vertigo", "de_dust2", "de_inferno", "de_mirage",
    ],
    "Surf": [
        "surf_kitsune", "surf_utopia_njv", "surf_beginner", "surf_mesa_revo",
        "surf_deathstar", "surf_rookie", "surf_benevolent", "surf_ace",
        "surf_boreas", "surf_nyx", "surf_whiteout", "surf_ski_2",
    ],
    "KZ": [
        "only_up", "kz_dima", "kz_checkmate", "kz_victoria",
        "kz_rc_stonehenge", "kz_sxb2_cxz", "kz_rc_twotowers",
        "kz_simplyhard", "kz_nomibo", "kz_sxb2_biewan", "kz_ggsh", "kz_ltt",
    ],
    "BHop": [
        "bhop_at_night", "bhop_ragnarok", "bhop_zunron", "bhop_1derland",
        "bhop_whiteshit", "bhop_cherryblossom", "bhop_arcturus", "bhop_kiwi_cwfx",
    ],
    "GunGame": [
        "ar_shoots", "ar_shoots_night", "ar_baggage", "ar_pool_day",
        "speedball", "gg_lego_arena", "de_indoor", "fy_iceworld", "daymare",
    ],
    "Deathrun": [
        "deathrun_playground", "deathrun_egypt", "deathrun_civilization",
        "deathrun_iceworld_cs2",
    ],
    "Course": [
        "cr_devisland_p1_v1", "mg_switch_course_v2", "cr_minecraft_jb_v2",
        "mg_metro_course_v1", "mg_alley_course_v2", "mg_glave_course_v2",
        "mg_office_course_v3", "mg_circle_course_v3", "mg_simpsons_course_v2",
    ],
    "Hide n Seek": [
        "de_nuke_prophunt", "de_overpass_prophunt", "de_inferno_prophunt",
        "de_vertigo_prophunt", "de_mirage_prophunt",
    ],
    "Battle Royale": [
        "br_t2", "br_electrified", "br_stacks", "br_flood",
        "minecraft", "minecraft_hungergame",
    ],
    "Aim": [
        "aim_map", "freebet_aim_map", "fy_pool_day", "aim_usp",
        "aim_deagle", "1v1aim_map_longdustversion_d",
    ],
    "Capture The Flag": ["ctf_2fort", "ctf_doublecross", "ctf_turbine"],
    "ScoutzKnivez": ["scoutzknivez_pure_cs2", "ar_dizzy"],
    "AWP": ["awp_bhop_rocket"],
    "1v1": ["aim_redline_fp"],
}
